...
void insertNPM_V(CString oid,CString value,CSnmpObj *p_Object)
{
	...
	if(zd[8].GetLength())
	{
		...
		{
			if(value=="A")
				p_Object->devicetype[deindex] = "NPDU-V-A";
			else if(value=="B")
				p_Object->devicetype[deindex] = "NPDU-V-B";
			else if(value=="C")
				p_Object->devicetype[deindex] = "NPDU-V-C";
			else if(value=="D")
				p_Object->devicetype[deindex] = "NPDU-V-D";
			else if(value=="E")
				p_Object->devicetype[deindex] = "NPDU-V-E";
			else if(value=="F")
				p_Object->devicetype[deindex] = "NPDU-V-A";
			else if(value=="G")
				p_Object->devicetype[deindex] = "NPDU-V-B";
        ...
        if(p_Object->devicetype[deindex] == "NPDU-V-A"||p_Object->devicetype[deindex] == "NPDU-V-B"||p_Object->devicetype[deindex] == "NPDU-V-C"||p_Object->devicetype[deindex] == "NPDU-V-D")
		{
				if(zd[10] == "3")
				{
					if(zd[11] == "1")//t_power
				...
				else if(zd[10] == "6")//tem hum
				{
					...
					else if(zd[11]=="9")
					{
						if(value&&value.GetLength())
							p_Object->Door1[deindex]=value;
						else
							p_Object->Door1[deindex]="None.";
					}
					else if(zd[11]=="10")
					{
						if(value&&value.GetLength())
							p_Object->Door2[deindex]=value;
						else
							p_Object->Door2[deindex] ="None.";
					}
					else if(zd[11]=="11")
					{
						if(value&&value.GetLength())
							p_Object->Smoke[deindex] =value;
						else
							p_Object->Smoke[deindex] ="None.";
					}
					else if(zd[11]=="12")
					{
						if(value&&value.GetLength())
							p_Object->Water[deindex] =value;
						else
							p_Object->Water[deindex] ="None.";
					}
					/////////////////////////////温湿度最小最大值2*6=12  
